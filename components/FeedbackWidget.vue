<template>
  <div class="mt-12 pt-8" style="border-top: 1px solid var(--color-border)">
    ...
    <div class="text-center mb-6">
      <p class="mb-3" style="color: var(--color-text-muted)">这篇文章对你有帮助吗？</p>
      <div class="flex justify-center gap-3">
        <button
          ...
          :style="selected === option.value ? '' : { borderColor: 'var(--color-border)', background: 'var(--color-bg-surface)', color: 'var(--color-text-muted)' }"
        >
    ...
    <div class="mt-6 text-center">
      <a
        ...
        class="inline-flex items-center gap-2 text-sm transition-colors hover:text-blue-400"
